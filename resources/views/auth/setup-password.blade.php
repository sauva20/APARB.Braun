...
<head>
    ...
    <style>
        ...
        @font-face {
            font-family: 'Rotis Sans Serif';
            src: url('/fonts/RotisSansSerif-Italic.ttf') format('truetype');
            font-weight: normal;
            font-style: italic;
            font-display: swap;
        }
        ...
        @font-face {
            font-family: 'Rotis Sans Serif';
            src: url('/fonts/RotisSansSerif-BoldItalic.ttf') format('truetype');
            font-weight: bold;
            font-style: italic;
            font-display: swap;
        }
        ...
        <div class="p-8 sm:p-10">
            ...
            <div class="flex justify-center mb-8">
                <div class="flex items-center justify-center bg-gradient-to-br from-[#009B77]/10 to-[#009B77]/5 w-16 h-16 rounded-2xl border border-[#009B77]/20 shadow-inner">
                    <i class="ph-duotone ph-key text-4xl text-[#009B77]"></i>
                </div>
            </div>
            ...
            <form action="{{ URL::full() }}" method="POST" class="space-y-5">
                ...
                <!-- Email (Readonly) -->
                <div>
                    <label class="block text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-2">Email</label>
            ...
            @else
            <form action="{{ route('setup-password', ['user' => $user->id]) }}{{ request()->has('signature') ? '?expires=' . request('expires') . '&signature=' . request('signature') : '' }}" method="POST" class="space-y-5">
                @csrf
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" id="password" name="password" placeholder="Minimal 8 karakter" minlength="8"
                            class="w-full pl-11 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl focus:ring-4 focus:ring-[#009B77]/10 focus:border-[#009B77] focus:bg-white transition-all outline-none text-[#1A1A1A] text-sm tracking-widest font-mono placeholder:font-sans placeholder:tracking-normal" required autofocus>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Ulangi password di atas" minlength="8"
