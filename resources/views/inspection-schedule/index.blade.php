...
<div x-data="{ showPanelHasil: false, showPanelDetail: false, showModalBuatJadwal: false, selectedInspeksi: null }">
    <!-- Header -->
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:h-[calc(100vh-230px)]">
        ...
        <div class="lg:col-span-2 flex flex-col space-y-4 lg:overflow-y-auto lg:pr-3 pb-8 custom-scrollbar">
            ...
            <div class="flex-shrink-0">
                <h3 class="text-sm font-bold text-slate-500 uppercase tracking-wider mb-3 flex items-center gap-2 sticky top-0 bg-[#F8FAFC] z-10 py-2">
                    <i class="ph-bold ph-calendar-star text-[#009B77]"></i> Progress Inspeksi Bulan Ini
                </h3>
                <div class="space-y-4">
                    ...
                    @if($countTotal > 0)
                    <div x-data="{ expanded: true }" class="bg-white rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden transition-all flex-shrink-0">
                        <!-- Header -->
                        <div @click="expanded = !expanded" class="cursor-pointer w-full flex items-center justify-between p-5 bg-slate-50/50 hover:bg-slate-50 transition-colors border-b border-slate-100">
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-8 h-8 rounded-full bg-white border border-slate-200 flex items-center justify-center text-slate-400 transition-transform duration-300" :class="expanded ? 'rotate-180' : ''">
                ...
                <div class="mt-10">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm transition-all hover:shadow-md">
                            <div class="flex items-start justify-between gap-4">
                                <div class="flex gap-4">
                                    <div class="w-12 h-12 rounded-xl bg-[#009B77]/5 border border-[#009B77]/20 flex items-center justify-center flex-shrink-0 text-[#009B77]">
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2 mb-1.5 flex-wrap">
                                            ...
                                            <span class="text-[10px] font-bold px-2 py-0.5 rounded-md bg-blue-50 text-blue-600 border border-blue-100 flex items-center gap-1 uppercase tracking-wider"><i class="ph-bold ph-calendar-blank"></i> {{ \Carbon\Carbon::parse($jadwal->tanggal_inspeksi)->translatedFormat('d M Y') }}</span>
                                        </div>
