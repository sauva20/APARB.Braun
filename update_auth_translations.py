...
translations_id = {
    "Email atau Password yang Anda masukkan salah.": "Email atau Password yang Anda masukkan salah."
}

translations_en = {
    "Email atau Password yang Anda masukkan salah.": "The email or password you entered is incorrect."
}
