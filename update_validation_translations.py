...
translations_id = {
    "Foto kondisi APAR wajib diambil sebelum submit.": "Foto kondisi APAR wajib diambil sebelum submit."
}

translations_en = {
    "Foto kondisi APAR wajib diambil sebelum submit.": "PFE condition photo must be taken before submitting."
}
